...
public class DataReaderTest {
    ...
    public void testReadCSVTable1() throws IOException {
        Reader source = new FileReader("test/jpl/ch22/ex07/test1.csv");
    ...
    public void testReadCSVTable3() throws IOException {
        Reader source = new FileReader("test/jpl/ch22/ex07/test5.csv");
        List<String[]> actual = DataReader.readCSVTable(source, 4);
    ...
    public void testReadCSVTableThrowsIOException1() throws IOException {
        Reader source = new FileReader("test/jpl/ch22/ex07/test2.csv");
    ...
    public void testReadCSVTableThrowsIOException2() throws IOException {
        Reader source = new FileReader("test/jpl/ch22/ex07/test3.csv");
        DataReader.readCSVTable(source, 4);
    ...
    @Test(expected=IOException.class)
    public void testReadCSVTableThrowsIOException3() throws IOException {
        Reader source = new FileReader("test/jpl/ch22/ex07/test4.csv");
        DataReader.readCSVTable(source, 4);
