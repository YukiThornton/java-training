...
public class LinkedListTest {
    ...
    @Test
    public void testFindReturnsOne() throws ObjectNotFoundException {
        String element1 = "element1";
        String element2 = "element2";
        ...
        assertEquals(linkedList2, linkedList1.find(element2));
    }

    @Test(expected=ObjectNotFoundException.class)
    public void testFindReturnsException() throws ObjectNotFoundException {
        String element1 = "element1";
        String element2 = "element2";
        
        LinkedList<String> linkedList1 = new LinkedList<String>(element1);
        
        linkedList1.find(element2);
    }
