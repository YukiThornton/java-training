...
public class Vehicle implements Cloneable{
	...
	public Vehicle clone() {
		...
		Vehicle clonedVehicle = null;
		try {
			clonedVehicle = new Vehicle(clonedEnergySources, getOwner());
		} catch (WrongVehicleUsageException e) {
			// do nothing. 
			e.printStackTrace();
		}
		clonedVehicle.setSpeed(speed);
		clonedVehicle.setDirection(direction);
	...
	public class WrongVehicleUsageException extends Exception {
		public WrongVehicleUsageException(String message) {
			super(message);
		}
	}
}
