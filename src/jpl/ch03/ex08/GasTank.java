...
public class GasTank extends EnergySource {
	...
	public boolean equals(Object obj) {
		...
		if (Double.doubleToLongBits(MAX_GAS_LEVEL) != Double.doubleToLongBits(other.MAX_GAS_LEVEL))
			return false;
		if (Double.doubleToLongBits(gasLevel) != Double.doubleToLongBits(other.gasLevel))
			return false;
		return true;
	}
	...
	/**
	 * インスタンスのコピーを返すメソッド.
	 * @return GasTankのインスタンス
	 */
	public GasTank clone() {
		GasTank gt = null;
		try {
			gt = new GasTank(MAX_GAS_LEVEL, gasLevel);
