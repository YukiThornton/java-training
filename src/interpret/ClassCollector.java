...
public class ClassCollector {
    ...
    public String[] getPackages() {
        String[] keys = map.keySet().toArray(new String[map.size() + 1]);
        if (Package.getPackage("interpret") != null)
            keys[keys.length - 1] = "interpret";
        return keys;
    }

    public String[] getSortedPackages() {
        String[] packages = getPackages();
        Arrays.sort(packages, new Comparator<String>() {
            @Override
            public int compare(String pack1, String pack2) {
    ...
    private void loadClasses() {
        ...
        // java.lang
        Class<?>[] langArray = {
                Boolean.class, Byte.class, Character.class, Class.class, ClassCollector.class,
        ...
        map.put("java.lang", Arrays.asList(langArray));
        ...
        map.put("java.awt", Arrays.asList(awtArray));
