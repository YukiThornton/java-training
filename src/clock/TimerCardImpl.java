...
class TimerCardImpl implements TimerCard {
    ...
    static class Builder implements TimerCard.Builder {
        ...
        private Consumer<String> onInvalidInputForTimerDutaion;
        private BiConsumer<TimerCard, Timer> onTimerDeletionRequested;
        ...
        @Override
        public TimerCard.Builder onInvalidInputForTimerDuration(Consumer<String> action) {
            this.onInvalidInputForTimerDutaion = action;
            return this;
        }

        @Override
        public TimerCard.Builder onTimerDeletionRequested(BiConsumer<TimerCard, Timer> action) {
        ...
        public TimerCard build() {
            if ((timer == null)
                    ...
                    || (onInvalidInputForTimerDutaion == null)
    ...
    private TimerCardImpl(Builder builder) {
        ...
        deleteTimerButton.setOnMouseClicked(e -> {
            if (!this.timer.isRunning()) {
                builder.onTimerDeletionRequested.accept(this, this.timer);
            }
        });
