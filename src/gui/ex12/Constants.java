...
public class Constants {
	...
	public final static Dimension FIXED_DIALOG_SIZE = new Dimension(250, 300);
	
	public final static Font DEFAULT_FONT = new Font("arial black", Font.PLAIN, 24);
	public final static int MINIMUM_FONT_SIZE = 10;
	public final static int MAXIMUM_FONT_SIZE = 140;
